...
import { cardStyles, componentStyles } from "@/styles/common";
...
export default function FeedItem({
  ...
  return (
    <Card className={cardStyles.feed}>
      {/* 작성자 정보 */}
      <div className="px-6 py-4 border-b border-gray-100">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div
              className={`${componentStyles.avatar.base} ${componentStyles.avatar.medium} bg-gradient-to-br from-blue-400 to-purple-500`}
            >
