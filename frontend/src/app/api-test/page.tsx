      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            {responses.health && <ResponseBox response={responses.health} />}
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            {responses.signup && <ResponseBox response={responses.signup} />}
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            {responses.login && <ResponseBox response={responses.login} />}
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            {responses.me && <ResponseBox response={responses.me} />}
          </div>
