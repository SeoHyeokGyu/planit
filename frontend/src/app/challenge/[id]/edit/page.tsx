...
export default function EditChallengePage() {
    ...
    const { isActive, isUpcoming, isEnded } = useMemo(() => {
        ...
        const active = !!(challenge?.isActive || (startDate && endDate && now >= startDate && now <= endDate));
            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                            ...
                            {isActive ? (
                                <Alert className="border-amber-200 bg-amber-50">
                                    ...
                                    <AlertDescription className="text-sm text-amber-900 font-semibold">
                                        ⚠️ 진행 중인 챌린지입니다. 제목과 설명만 수정할 수 있으며, 카테고리, 난이도, 날짜는 수정할 수 없습니다.
                                    </AlertDescription>
                                </Alert>
                            ) : isUpcoming ? (
                ...
                <div className="mt-6 p-4 bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg border border-purple-200">
                    ...
                    <ul className="text-sm text-purple-900 space-y-1 font-medium">
                        <li>• <strong>시작 전</strong>: 모든 정보를 자유롭게 수정할 수 있습니다</li>
                        <li>• <strong>진행 중</strong>: 제목과 설명만 수정 가능하며, 카테고리/난이도/날짜는 수정할 수 없습니다</li>
                        <li>• <strong>종료됨</strong>: 챌린지를 수정할 수 없습니다</li>
