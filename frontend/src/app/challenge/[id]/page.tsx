...
export default function ChallengeDetailPage() {
  ...
  return (
    <div className={layoutStyles.pageRoot}>
      <div className={layoutStyles.containerLg}>
        ...
        <div className={headerStyles.wrapper}>
          <div className={headerStyles.content}>
            ...
            <h1 className={`${headerStyles.title} ${themeStyles.primary.text}`}>챌린지 상세</h1>
          </div>
          <p className={headerStyles.description}>챌린지 정보를 확인하고 참여하세요</p>
        </div>

        {/* Header Card */}
        <Card className={`${cardStyles.base} mb-6`}>
          <CardHeader className={`${cardStyles.headerGradient} ${themeStyles.primary.headerBg}`}>
            <div className="flex justify-between items-start gap-4">
              <div className="flex-1">
                ...
                <CardTitle className="text-3xl mb-2 text-gray-900 font-bold">
                  {challenge.title}
                </CardTitle>
            ...
            <CardFooter className="border-t bg-gray-50 flex gap-3">
              {!isParticipating ? (
                <Button
                  ...
                  className={`flex-1 ${themeStyles.primary.btn} h-12 font-bold`}
                >
